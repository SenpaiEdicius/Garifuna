        ...
        <Page pageURL="WELCOME?" auth={auth}>
            <section className="page-landing">
                <div className="landing-photo col-s-12 col-m-9 col-10 no-padding">
                    <h2 className="titulo1">Sobre Nosotros</h2>
                </div>
                <p>
...
así como en la propuesta de Pay-ne (1991), el garífuna pertenece a la rama caribeña del tronco norte dela familia arahuaca; sus parientes más cercanos son el guajiro (Co-lombia-Venezuela), el locono o arahuaco (Surinam) y los extintostaino (Antillas) y paraujano (Venezuela).
